...
#third line is the number of total light channels
#fourth and on lines are events, with time from the start of the song to do the action, ON or OFF, then the strings to apply the change to.
...
# this file must be in chronological order - if your timing is out of place, funny things will happen.  add error checking here
